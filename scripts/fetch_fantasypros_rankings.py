...
def main() -> None:
    ...
    parser.add_argument("--ranking-type", default=None, help="e.g. ADP, ROS, DK; omit for preseason ECR")
    ...
    stem = f"{args.season}_{args.scoring.lower()}_{args.qb_format}_{args.position.lower()}_{ranking_label}_{timestamp}"
