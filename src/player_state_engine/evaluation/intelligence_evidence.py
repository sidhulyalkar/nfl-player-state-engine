...
def family_feature_columns(
    ...
    *,
    ...
    # Canonical ledger-derived fields are generated by the cutoff-specific research adapter and
    # are not part of the legacy weekly feature allowlist. Admit only those explicit prefixes.
    canonical_prefix = {
