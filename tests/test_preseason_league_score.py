...
def _base() -> pd.DataFrame:
    return pd.DataFrame(
        [
            {"season": 2025, "player_id": "p1", "player_name": "Player One", "position": "RB", "recent_team": "A"},
            {"season": 2025, "player_id": "p2", "player_name": "Player Two", "position": "WR", "recent_team": "B"},
            {"season": 2025, "player_id": "p3", "player_name": "Zero Player", "position": "TE", "recent_team": "C"},
        ]
    )
